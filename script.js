...
function openFilterModal(type){
  ...
  openModal(()=>{
    modal.innerHTML = `
      ${modalHead(title)}
      <div class="small">Select one or more. “Any” clears this filter.</div>
      <div class="optgrid">
...
function renderActivity(){
  ...
  card(`
    ...
    ${civicHidden ? `<div class="p" style="margin-top:12px"><strong>Note:</strong> Civic mixing is ON (some spins include a hidden community ripple).</div>` : ``}
  `);
